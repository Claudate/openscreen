export const dict = {
	...
	recording: {
		starting: "Starting",
		micIssue: "Microphone disconnected. Silence will be used until it reconnects.",
		cameraIssue: "Camera disconnected. Recording continues without camera overlay.",
		micDisconnected: "Microphone disconnected",
		micTitle: "Microphone: {{name}}",
