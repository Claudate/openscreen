...
const modes = (): ModeDetail[] => [
	{
		id: "instant",
		title: t("onboardingPage.modes.instantTitle"),
		tagline: t("onboardingPage.modes.instantTagline"),
		description: t("onboardingPage.modes.instantDescription"),
		icon: IconCapInstant,
		features: [
			t("onboardingPage.modes.instantFeature1"),
			t("onboardingPage.modes.instantFeature2"),
			t("onboardingPage.modes.instantFeature3"),
			t("onboardingPage.modes.instantFeature4"),
		],
	},
	{
		id: "studio",
		title: t("onboardingPage.modes.studioTitle"),
		tagline: t("onboardingPage.modes.studioTagline"),
		description: t("onboardingPage.modes.studioDescription"),
		icon: IconCapFilmCut,
		features: [
			t("onboardingPage.modes.studioFeature1"),
			t("onboardingPage.modes.studioFeature2"),
			t("onboardingPage.modes.studioFeature3"),
			t("onboardingPage.modes.studioFeature4"),
		],
	},
	{
		id: "screenshot",
		title: t("onboardingPage.modes.screenshotTitle"),
		tagline: t("onboardingPage.modes.screenshotTagline"),
		description: t("onboardingPage.modes.screenshotDescription"),
		icon: IconCapScreenshot,
		features: [
			t("onboardingPage.modes.screenshotFeature1"),
			t("onboardingPage.modes.screenshotFeature2"),
			t("onboardingPage.modes.screenshotFeature3"),
			t("onboardingPage.modes.screenshotFeature4"),
		],
	},
];
...
const setupPermissions = (): readonly SetupPermission[] => [
	{
		name: t("onboardingPage.permScreenRecordingName"),
		key: "screenRecording",
		description: t("onboardingPage.permScreenRecordingDesc"),
		requiresManualGrant: false,
	},
	{
		name: t("onboardingPage.permAccessibilityName"),
		key: "accessibility",
		description: t("onboardingPage.permAccessibilityDesc"),
		requiresManualGrant: false,
	},
	{
		name: t("onboardingPage.permMicrophoneName"),
		key: "microphone",
		description: t("onboardingPage.permMicrophoneDesc"),
		requiresManualGrant: false,
		optional: true,
	},
	{
		name: t("onboardingPage.permCameraName"),
		key: "camera",
		description: t("onboardingPage.permCameraDesc"),
		requiresManualGrant: false,
		optional: true,
	},
];
...
export default function OnboardingPage() {
	...
	const nextLabel = () => {
		if (permissionsOnly()) return t("onboardingPage.continueToApp");
		if (step() === totalSteps() - 1) return t("onboardingPage.startUsing");
		return t("onboardingPage.continueButton");
	};
				...
				<div class="flex-1 flex justify-end">
					<div class="flex flex-col items-center gap-1.5">
						...
						<Show when={props.showSkipOnboarding}>
							...
							>
								{t("onboardingPage.skipOnboarding")}
							</button>
						</Show>
					</div>
				</div>
		...
		<div class="flex flex-col items-center justify-center min-h-full px-10 gap-8">
			...
			>
				<h2 class="text-2xl font-bold text-gray-12 tracking-tight">
					{t("onboardingPage.overviewTitle")}
				</h2>
				<p class="text-[14px] text-gray-10 leading-relaxed">
					{t("onboardingPage.overviewDesc")}
				</p>
			</div>
...
function ToggleStep(props: { active: boolean }) {
	...
	return (
		<div class="flex flex-col items-center justify-center min-h-full px-12 gap-8">
			...
			>
				<h2 class="text-2xl font-bold text-gray-12 tracking-tight">
					{t("onboardingPage.toggleTitle")}
				</h2>
				<p class="text-[14px] text-gray-10 leading-relaxed">
					{t("onboardingPage.toggleDesc")}
				</p>
			</div>
...
function ShortcutsStep(props: { active: boolean }) {
	...
	const settingsAreas = () => [
		{
			title: t("onboardingPage.settingsAreas.shortcutsTitle"),
			desc: t("onboardingPage.settingsAreas.shortcutsDesc"),
		},
		{
			title: t("onboardingPage.settingsAreas.s3Title"),
			desc: t("onboardingPage.settingsAreas.s3Desc"),
		},
		{
			title: t("onboardingPage.settingsAreas.domainTitle"),
			desc: t("onboardingPage.settingsAreas.domainDesc"),
		},
		{
			title: t("onboardingPage.settingsAreas.prefsTitle"),
			desc: t("onboardingPage.settingsAreas.prefsDesc"),
		},
	];
	...
	return (
		<div class="flex flex-col items-center justify-center min-h-full px-12 gap-6">
			...
			>
				...
				<h2 class="text-2xl font-bold text-gray-12 tracking-tight">
					{t("onboardingPage.customizeTitle")}
				</h2>
				<p class="text-[14px] text-gray-10 leading-relaxed">
					{t("onboardingPage.customizeDesc")}
				</p>
			</div>
			...
			>
				{t("onboardingPage.changeAnytime")}
			</p>
		</div>
	);
}
...
function FaqStep(props: { active: boolean }) {
	...
	return (
		<div class="flex flex-col items-center justify-center min-h-full px-12 py-6 gap-6">
			...
			>
				<h2 class="text-2xl font-bold text-gray-12 tracking-tight">
					{t("onboardingPage.faqTitle")}
				</h2>
				<p class="text-[14px] text-gray-10">
					{t("onboardingPage.faqSubtitle")}
				</p>
			</div>
			...
			>
				<FaqItem question={t("onboardingPage.faqQuestion1")}>
					<p class="text-[13px] text-gray-10 leading-relaxed">
						{t("onboardingPage.faqAnswer1Prefix")}{" "}
						<button
							type="button"
							onClick={() => shell.open("https://cap.so/pricing")}
							class="text-blue-10 hover:text-blue-11 underline underline-offset-2"
						>
							{t("onboardingPage.pricingPlans")}
						</button>
						.
					</p>
				</FaqItem>
				<FaqItem question={t("onboardingPage.faqQuestion2")}>
					<p class="text-[13px] text-gray-10 leading-relaxed">
						{t("onboardingPage.faqAnswer2")}
					</p>
				</FaqItem>
				<FaqItem question={t("onboardingPage.faqQuestion3")}>
					<p class="text-[13px] text-gray-10 leading-relaxed">
						{t("onboardingPage.faqAnswer3")}
					</p>
				</FaqItem>
				<FaqItem question={t("onboardingPage.faqQuestion4")}>
					<p class="text-[13px] text-gray-10 leading-relaxed">
						{t("onboardingPage.faqAnswer4")}
					</p>
				</FaqItem>
				<FaqItem question={t("onboardingPage.faqQuestion5")}>
					<p class="text-[13px] text-gray-10 leading-relaxed">
						{t("onboardingPage.faqAnswer5")}
					</p>
				</FaqItem>
			</div>
...
function StartRecordingClickMock(props: {
	...
	const modeLabel = () =>
		props.mode === "studio"
			? t("onboardingPage.modes.studioTitle")
			: t("onboardingPage.modes.instantTitle");
					...
					<div class="flex min-w-0 flex-1 items-center py-1 pl-4 pointer-events-none">
						...
						<div class="mr-2 ml-3 flex min-w-0 flex-col">
							<span class="text-[0.95rem] font-medium text-nowrap text-white">
								{t("onboardingPage.startRecording")}
							</span>
...
function InstantMockup(props: { active: boolean }) {
	...
	return (
		<div class="w-full h-full flex flex-col min-h-0 p-4">
			<MockupStepBar
				steps={[
					t("onboardingPage.stepRecord"),
					t("onboardingPage.stepStop"),
					t("onboardingPage.stepShareLink"),
				]}
						...
						<div class="flex flex-col items-center gap-3 px-4 py-4">
							<div class="flex items-center gap-2">
								...
								<span class="text-[12px] font-medium text-gray-12">
									{t("onboardingPage.linkReadyToShare")}
								</span>
							</div>
									...
									<Show
										...
										fallback={
											<>
												...
												{t("onboardingPage.copy")}
											</>
										}
									>
										<IconLucideCheck class="size-3" />
										{t("onboardingPage.copied")}
									</Show>
								</div>
							</div>
						</div>
	...
	return (
		<div class="w-full h-full flex flex-col min-h-0 p-4">
			<MockupStepBar
				steps={[
					t("onboardingPage.stepRecord"),
					t("onboardingPage.stepEdit"),
					t("onboardingPage.stepExport"),
				]}
				activeStep={activeStep()}
			/>
					...
					<div class="flex bg-white dark:bg-gray-1 flex-1 relative">
						...
						>
							...
							<div class="text-[8px] text-gray-9 font-medium uppercase tracking-wider mt-1">
								{t("onboardingPage.backgroundLabel")}
							</div>
							<div class="flex gap-1">
										...
										fallback={
											<div class="flex items-center gap-2">
												...
												<span class="text-sm font-medium text-gray-12">
													{t("onboardingPage.exportComplete")}
												</span>
											</div>
										}
									>
										<span class="text-sm font-medium text-gray-12">
											{t("onboardingPage.exporting")}
										</span>
									</Show>
	...
	const maybePromptRestartForPermission = async (permission: OSPermission) => {
		const message =
			permission === "accessibility"
				? t("onboardingPage.restartAccessibility")
				: t("onboardingPage.restartOther");
		const shouldRestart = await ask(message, {
			title: t("onboardingPage.restartTitle"),
			kind: "info",
			okLabel: t("onboardingPage.restartOk"),
			cancelLabel: t("onboardingPage.restartCancel"),
		});
		if (shouldRestart) {
			await relaunch();
		}
	...
	return (
		...
		>
			...
			>
				...
				<h2 class="text-2xl font-bold text-gray-12 tracking-tight">
					{t("onboardingPage.permissionsTitle")}
				</h2>
				<p class="text-[14px] text-gray-10 leading-relaxed">
					{t("onboardingPage.permissionsDesc")}
				</p>
			</div>
								...
								>
									...
									>
										...
										>
											{permission.requiresManualGrant ||
											permStatus() === "denied"
												? t("onboardingPage.openSettings")
												: t("onboardingPage.grant")}
										</Button>
									</Show>
								</div>
							</Show>
...
function ScreenshotMockup(props: { active: boolean }) {
	...
	return (
		<div class="w-full h-full flex flex-col items-center justify-center p-4">
			<MockupStepBar
				steps={[
					t("onboardingPage.stepSelectArea"),
					t("onboardingPage.stepBeautify"),
					t("onboardingPage.stepCopy"),
				]}
				activeStep={activeStep()}
			/>
					...
					<div class="w-full max-w-[420px] rounded-xl overflow-hidden border border-gray-3 bg-white dark:bg-gray-2 shadow-lg">
						...
						>
							<div class="flex items-center gap-1.5 px-3 py-1 rounded-full bg-gray-12 text-gray-1 text-[10px] font-medium">
								<IconLucideCheck class="size-3" />
								{t("onboardingPage.copiedToClipboard")}
							</div>
						</div>
					</div>
				</div>
