						...
						<div class="p-8 mx-auto mt-6 w-full max-w-[700px] text-white rounded-xl border border-gray-3 bg-gray-2">
							<div class="space-y-6">
								<div class="flex flex-col gap-2 items-center mb-4 text-center">
									...
									<h3 class="text-2xl font-medium text-gray-12">
										{t("settings.license.commercialTitle")}
									</h3>
								</div>
								<div>
								...
								<div class="flex flex-col items-center">
									...
									>
										{t("settings.license.deactivateLicense")}
									</Button>
								</div>
							</div>
						</div>
						...
						<div class="p-6 mx-auto w-full rounded-xl border text-gray-12 bg-gray-2 border-gray-3">
							<div class="space-y-3">
								<h3 class="mb-2 text-xl text-center">
									{t("settings.license.haveLicenseKey")}
								</h3>
								<Input
				...
				<div class="flex flex-col md:flex-row">
					...
					>
						...
						<div class="space-y-1 text-center">
							<h3 class="text-2xl font-medium tracking-tight leading-5">
								{t("settings.license.commercialLicenseTitle")}
							</h3>
							<p class="mt-2 text-sm text-(--text-tertiary)">
								{t("settings.license.forCommercialUse")}
							</p>
						</div>
						<div class="flex flex-col justify-center items-center mt-5">
							...
							<p class="text-[16px] font-medium text-gray-11">
								{isCommercialAnnual()
									? t("settings.license.billedAnnually")
									: t("settings.license.oneTimePayment")}
							</p>
						</div>
						<div
						...
						>
							<p class="text-xs text-gray-12">
								{t("settings.license.switchToPlan", {
									plan: isCommercialAnnual()
										? t("settings.license.lifetimePlan")
										: t("settings.license.yearlyPlan"),
								})}{" "}
						...
						>
							{openCommercialCheckout.isPending
								? t("common.loading")
								: t("settings.license.purchaseLicense")}
						</Button>
					</div>
					...
					<div class="flex flex-col gap-4 justify-center items-center p-5 rounded-t-none rounded-b-xl border border-t-0 md:border-t md:border-l-0 md:rounded-bl-none md:rounded-tr-xl md:rounded-br-xl md:w-1/2 border-gray-3">
						<ul class="flex flex-col gap-2 list-none">
							{[
								t("settings.license.featureCommercialUse"),
								t("settings.license.featureCommunitySupport"),
								t("settings.license.featureLocalOnly"),
								t("settings.license.featurePerpetualLicense"),
							].map((feature) => (
