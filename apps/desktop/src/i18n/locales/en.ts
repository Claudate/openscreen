export const dict = {
	...
	editor: {
		...
		export: {
			...
			destinationLinkDesc: "Share via Reko cloud",
		...
		header: {
			...
			importExistingCapRecording: "Existing Reko Recording...",
		...
		player: {
			...
			mergeSegments: "Merge selected segments",
			selectMode: "Select",
			splitMode: "Split",
			snapToggle: "Snap",
		},
		...
		segment: {
			...
			maskSilhouette: "Silhouette",
			maskEdgeGlow: "Edge Glow",
			intensity: "Intensity",
		...
		org: {
			...
			fetching: "Fetching organization branding from Reko web.",
			unavailableDesc:
				"Organization branding uses live Reko web data. Connect to Reko web to select an organization and use its colours.",
			signInDesc:
