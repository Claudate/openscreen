...
export default function AppsTab() {
	...
	const apps = [
		{
			name: t("settings.integrations.googleDrive.name"),
			description: t("settings.integrations.googleDrive.listDescription"),
		...
		},
		{
			...
			description: t("settings.integrations.s3.listDescription"),
									...
									<div class="flex justify-between items-center gap-3">
										...
										>
											{managedByOrganization()
												? t("settings.integrations.managedByOrganization")
												: app.pro && !isPro()
